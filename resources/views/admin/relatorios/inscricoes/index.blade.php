...
@section('subtitle')
    Visualize inscrições realizadas e sua conversão em matrícula.
@endsection
...
@section('breadcrumb')
    <x-admin.breadcrumb :items="[
        ...
        ['label' => 'Inscrições', 'icon' => 'user-plus', 'current' => true],
    ]" />
@endsection
    ...
    <div class="space-y-6">
        ...
        <form method="GET" action="{{ route('admin.relatorios.inscricoes.index') }}" class="space-y-4">
            ...
            <div class="flex flex-wrap items-center justify-end gap-2">
                <x-admin.action as="a" variant="ghost" icon="x" href="{{ route('admin.relatorios.inscricoes.index') }}">Limpar</x-admin.action>
